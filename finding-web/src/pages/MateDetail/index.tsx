      ...
      {mate.author && !mate.isAnonymous && (
        <div className="md-section">
          ...
          <div className="md-author-row">
            <div className="md-author-avatar" onClick={profileClick(mate.author.id)}>
        ...
        <div className="md-section">
          ...
          {participants.length === 0 ? (
            ...
            <div key={p.participantId} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 0', borderBottom: '1px solid #f0f0f0' }}>
              <div onClick={profileClick(p.userId)} style={{ width: 36, height: 36, borderRadius: '50%', overflow: 'hidden', flexShrink: 0, background: '#f0f0f0' }}>
                {p.avatar
