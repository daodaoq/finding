...
import com.finding.app.entity.Banner;
import com.finding.user.entity.User;
import com.finding.user.entity.UserFollow;
import com.finding.app.mapper.BannerMapper;
...
public class HomeServiceImpl implements HomeService {
    ...
    public void likeUser(Long userId, Long targetUserId) {
        ...
        messageService.notify(userId, targetUserId, "like",
                (fromUser != null ? fromUser.getNickname() : "有人") + "对你表示了喜欢", null);
    }
