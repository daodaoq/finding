...
-- ============================================================
-- 11c2. stranger_message - 陌生人打招呼消息(未建立会话前,同一对用户仅一条)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `user_card_config` (
    ...
    `show_age` TINYINT NOT NULL DEFAULT 1 COMMENT '年龄',
    ...
    `show_verified` TINYINT NOT NULL DEFAULT 1 COMMENT '实名认证标识',
    `show_target_type` TINYINT NOT NULL DEFAULT 1 COMMENT '交友目标',
...
-- ============================================================
-- 32. user_like / user_match - 双向心动配对
-- ============================================================
...
-- ============================================================
-- 35. user_remark - 用户备注(私密别名,仅设置者本人可见)
-- ============================================================
